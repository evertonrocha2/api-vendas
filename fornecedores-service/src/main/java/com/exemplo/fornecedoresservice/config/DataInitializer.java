...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        fornecedorRepository.save(new Fornecedor("Beta Suprimentos", "23.456.789/0001-01"));
        fornecedorRepository.save(new Fornecedor("Gama Comercio", "34.567.890/0001-12"));
        fornecedorRepository.save(new Fornecedor("Delta Atacado", "45.678.901/0001-23"));
        fornecedorRepository.save(new Fornecedor("Omega Logistica", "56.789.012/0001-34"));
    }
}
